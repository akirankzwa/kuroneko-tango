...
class FlashcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flashcard" do
    assert_difference('Flashcard.count') do
      post flashcards_url, params: { flashcard: { definition: @flashcard.definition, status: @flashcard.status, term: @flashcard.term } }
    end
  ...
  test "should update flashcard" do
    patch flashcard_url(@flashcard), params: { flashcard: { definition: @flashcard.definition, status: @flashcard.status, term: @flashcard.term } }
