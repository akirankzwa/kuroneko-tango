...
class SpeechesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speech" do
    assert_difference('Speech.count') do
      post speeches_url, params: { speech: { definition: @speech.definition, status: @speech.status, term: @speech.term, voice: @speech.voice } }
    end
  ...
  test "should update speech" do
    patch speech_url(@speech), params: { speech: { definition: @speech.definition, status: @speech.status, term: @speech.term, voice: @speech.voice } }
